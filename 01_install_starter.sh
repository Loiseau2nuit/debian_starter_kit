...
${SUDO} apt -y install apticron ccze cowsay curl dnsutils exa fortunes git glpi-agent htop neofetch net-tools python3-pygments rsync screen sudo tmux whois zsh
