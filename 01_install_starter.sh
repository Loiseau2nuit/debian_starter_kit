...
${SUDO} apt-get -y install apticron bpytop ccze cowsay curl dnsutils exa fail2ban fortunes iptables iptables-persistent netcat-openbsd net-tools parted python3-pygments rkhunter rsync screen sudo tmux unzip whois zip zsh
